      ...
      <section className="relative pt-12 pb-20 overflow-hidden border-b border-slate-200/70">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            {/* Live Trust Metrics Bar -- capabilities the platform
                actually has today (196-jurisdiction data model, real
                spatial engine, real KYC/AML connector), not fabricated
                adoption numbers for a pre-Beta product. */}
            <div className="pt-8 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto border-t border-slate-200">
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                ...
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Sovereign Jurisdictions Supported</div>
              </div>
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                <div className="text-xl sm:text-2xl font-extrabold text-teal-600 font-mono">100%</div>
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Vector Cadastre Coverage</div>
              </div>
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                <div className="text-xl sm:text-2xl font-extrabold text-amber-600 font-mono">POPIA</div>
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">& FICA Aligned</div>
              </div>
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                <div className="text-xl sm:text-2xl font-extrabold text-emerald-600 font-mono">Beta</div>
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Now Onboarding Agencies</div>
              </div>
            </div>
          </div>

          {/* Interactive Hero Application Window Mockup */}
          <div className="mt-12 max-w-5xl mx-auto rounded-2xl bg-slate-900 border border-slate-700/80 ring-1 ring-slate-900/5 shadow-2xl shadow-cyan-950/30 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-2xl p-6 shadow-md">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-slate-200 pb-4 mb-6">
              ...
              <div className="text-right sm:text-right">
                ...
                <span className="text-xs font-bold text-cyan-600">{activeCountry.complianceAuthorityName || activeCountry.regulatoryBody}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs font-mono">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <span className="text-teal-700 font-bold text-sm">{activeCountry.landRegistryAuthority}</span>
              </div>
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                <span className="text-slate-400 text-[10px] block">LICENSING CREDENTIAL</span>
                <span className="text-amber-700 font-bold text-sm">{activeCountry.ffcLicenseName}</span>
              </div>
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                <span className="text-slate-400 text-[10px] block">DEFAULT CURRENCY</span>
                <span className="text-emerald-700 font-bold text-sm">{activeCountry.currency.symbol} ({activeCountry.currency.code})</span>
              </div>
            </div>
