...
export const MarketingLandingPage: React.FC<MarketingLandingPageProps> = ({ onEnterApp }) => {
  ...
  React.useEffect(() => {
    document.documentElement.lang = navigator.language || 'en-ZA';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-emerald-50/50 to-slate-200 text-slate-900 font-sans selection:bg-cyan-500 selection:text-white">
      {/* 1. TOP STICKY NAVIGATION BAR */}
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200 text-slate-700 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          {/* Logo & Brand */}
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-xl bg-slate-950 shadow-md ring-1 ring-slate-900/5 flex items-center justify-center overflow-hidden p-1.5">
              <img src="/logo.svg" alt="Ptah Realty" className="w-full h-full" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-extrabold text-base tracking-tight text-slate-900 font-sans">PTAH REAL ESTATE</span>
                <span className="text-[10px] font-bold bg-cyan-950 text-cyan-400 border border-cyan-800/80 px-1.5 py-0.2 rounded font-mono">
                  OS v2.5
                </span>
              </div>
              <p className="text-[10px] text-slate-500 hidden sm:block">Sovereign Land Registry & Real Estate Intelligence</p>
            </div>
          </div>

          {/* Nav Links */}
          <nav className="hidden lg:flex items-center gap-6 text-xs font-semibold text-slate-600">
            <a href="#features" className="hover:text-cyan-600 transition-colors">Platform Capabilities</a>
            <a href="#tools" className="hover:text-cyan-600 transition-colors">Cadastre & Tools</a>
            <a href="#jurisdictions" className="hover:text-cyan-600 transition-colors">196 Sovereign Jurisdictions</a>
            <a href="#pricing" className="hover:text-cyan-600 transition-colors">Pricing & Plans</a>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-cyan-700 hover:text-white bg-cyan-50 hover:bg-cyan-600 border border-cyan-300 rounded-lg transition-all"
            >
      ...
      {/* 2. HERO SECTION */}
      <section className="relative pt-12 pb-20 overflow-hidden border-b border-slate-200/70">
        ...
        <div className="absolute top-1/3 right-10 w-96 h-96 bg-[#006980]/10 blur-[100px] pointer-events-none rounded-full" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            {/* Regulatory Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/90 border border-cyan-300 text-cyan-700 text-xs font-medium shadow-sm">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.15]">
              Next-Gen Cadastral Intelligence & <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-teal-600 to-[#006980]">PropTech OS</span>
            </h1>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3.5">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 hover:border-slate-400 font-semibold text-sm rounded-xl transition-all flex items-center justify-center gap-2 shadow-sm"
              >
              ...
              <button
                ...
                onClick={onEnterApp}
                className="w-full sm:w-auto px-5 py-3.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-300 font-semibold text-sm rounded-xl transition-all flex items-center justify-center gap-2"
            ...
            <div className="pt-8 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto border-t border-slate-200">
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                <div className="text-xl sm:text-2xl font-extrabold text-cyan-600 font-mono">196</div>
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Sovereign Nations</div>
              </div>
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                <div className="text-xl sm:text-2xl font-extrabold text-teal-600 font-mono">140M+</div>
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Indexed Parcels</div>
              </div>
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                <div className="text-xl sm:text-2xl font-extrabold text-amber-600 font-mono">99.98%</div>
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Spatial Accuracy</div>
              </div>
              <div className="bg-white/80 border border-slate-200 rounded-xl p-3.5 text-center shadow-xs">
                <div className="text-xl sm:text-2xl font-extrabold text-emerald-600 font-mono">45k+</div>
                <div className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Licensed Practitioners</div>
              </div>
            </div>
          </div>
              ...
              <div className="md:col-span-2 relative p-4 bg-slate-900/40 flex flex-col justify-between border-b md:border-b-0 md:border-r border-slate-800">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="text-[11px] text-slate-400 bg-slate-900/80 px-2.5 py-1 rounded border border-slate-800">
                    Extent: <span className="font-bold text-white font-mono">485 mÂ²</span>
                  </div>
                </div>
      ...
      <section id="features" className="py-20 border-b border-slate-200/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-cyan-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-cyan-50 text-cyan-600 border border-cyan-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Layers className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">Interactive GIS Vector Cadastre</h3>
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] text-cyan-600 font-semibold flex items-center gap-1">
                <span>140M+ Parcels Mapped</span>
              </div>
            </div>

            {/* Feature 2 */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-teal-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-teal-50 text-teal-600 border border-teal-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Database className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">National Title Deeds Registry</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] text-teal-600 font-semibold flex items-center gap-1">
                <span>Direct Deeds Gateway Sync</span>
              </div>
            </div>

            {/* Feature 3 */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-amber-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 border border-amber-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Calculator className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">Automated CMA & Valuation Engine</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  Automated comparable sales clustering, suburb trend regression, price-per-square-meter indexing, and confidence scoring.
                </p>
              </div>
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] text-amber-600 font-semibold flex items-center gap-1">
                <span>RICS & SACPVP Compliant</span>
              </div>
            </div>

            {/* Feature 4 */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-emerald-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <ShieldCheck className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">Institutional KYC / AML & FICA Suite</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] text-emerald-600 font-semibold flex items-center gap-1">
                <span>POPIA / GDPR / AML Certified</span>
              </div>
            </div>

            {/* Feature 5 */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-blue-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 border border-blue-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Share2 className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">Multi-Portal Listing Syndication</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] text-blue-600 font-semibold flex items-center gap-1">
                <span>Global API Integrations</span>
              </div>
            </div>

            {/* Feature 6 */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-purple-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-purple-50 text-purple-600 border border-purple-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Kanban className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">Deal Kanban & Transaction CRM</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] text-purple-600 font-semibold flex items-center gap-1">
                <span>End-to-End Pipeline</span>
              </div>
            </div>

            {/* Feature 7 */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-pink-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-xl bg-pink-50 text-pink-600 border border-pink-200 flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Sparkles className="w-6 h-6" />
                </div>
                <h3 className="text-base font-bold text-slate-900">AI Copywriting & Media Studio</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 text-[11px] text-pink-600 font-semibold flex items-center gap-1">
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-cyan-400 transition-all group shadow-sm hover:shadow-md flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-bold text-slate-900">Client PDF Reports & Digital Agent Cards</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <section id="tools" className="py-20 border-b border-slate-200/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${
                activeInteractiveTab === 'cadastre'
                  ...
                  : 'bg-white text-slate-500 hover:text-slate-900 border border-slate-200 shadow-xs'
              }`}
            >
                ...
                <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 text-xs font-mono space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px]">
                    <div className="p-2 bg-slate-900 rounded">
                      ...
                      <span className="text-white font-bold">485.00 mÂ²</span>
                    </div>
                    <div className="p-2 bg-slate-900 rounded">
                ...
                <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 text-xs space-y-3">
                  ...
                  <div className="space-y-2 text-[11px]">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-mono font-bold">R 8,200,000 â€” R 8,700,000</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-400">Avg Suburb Price / mÂ²:</span>
                      <span className="text-amber-300 font-mono">R 17,422 / mÂ²</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 text-xs font-mono space-y-2.5">
                  ...
                  <div className="space-y-2 text-[11px]">
                    <div className="flex justify-between items-center p-1.5 bg-slate-900 rounded">
                      ...
                      <span className="text-emerald-400 text-[10px]">â— Active (Ref P24-8902)</span>
                    </div>
                    <div className="flex justify-between items-center p-1.5 bg-slate-900 rounded">
                      <span className="text-white font-bold">Private Property</span>
                      <span className="text-emerald-400 text-[10px]">â— Active (Ref PP-1048)</span>
                    </div>
                    <div className="flex justify-between items-center p-1.5 bg-slate-900 rounded">
                      <span className="text-white font-bold">Zillow MLS Feed</span>
                      <span className="text-cyan-400 text-[10px]">â— Ready to Publish</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="jurisdictions" className="py-20 border-b border-slate-200/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-50 border border-cyan-200 text-cyan-700 text-xs font-semibold">
          ...
          <div className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-2xl p-6 shadow-md">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <select
                    ...
                    className="bg-white text-slate-900 font-bold text-sm px-3 py-2 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs font-mono">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                <span className="text-slate-400 text-[10px] block">LEGAL IDENTIFIER</span>
                <span className="text-slate-900 font-bold text-sm">{activeCountry.legalIdentifierName}</span>
              </div>
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                <span className="text-slate-400 text-[10px] block">LAND REGISTRY AUTHORITY</span>
                <span className="text-teal-300 font-bold text-sm">{activeCountry.landRegistryAuthority}</span>
              </div>
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                <span className="text-slate-400 text-[10px] block">LICENSING CREDENTIAL</span>
                <span className="text-amber-300 font-bold text-sm">{activeCountry.ffcLicenseName}</span>
              </div>
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                <span className="text-slate-400 text-[10px] block">DEFAULT CURRENCY</span>
            ...
            <div className="mt-6 pt-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
              <span className="text-slate-400">
                Statutory Act: <span className="text-slate-700 font-semibold">{activeCountry.statutoryAct || 'National Land Deeds & Property Act'}</span>
              </span>
              <button
                onClick={onEnterApp}
      ...
      <section id="pricing" className="py-20 border-b border-slate-200/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-50 border border-cyan-200 text-cyan-700 text-xs font-semibold">
            ...
            <div className="pt-4 flex items-center justify-center gap-3 text-xs font-semibold">
              <span className={billingCycle === 'monthly' ? 'text-slate-900' : 'text-slate-400'}>Monthly Billing</span>
              <button
                onClick={() => setBillingCycle(billingCycle === 'monthly' ? 'annual' : 'monthly')}
                className="w-12 h-6 bg-slate-200 rounded-full p-1 transition-colors relative border border-slate-300"
              >
                <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between hover:border-slate-300 shadow-sm transition-all">
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-bold text-slate-900">Starter Practitioner</h3>
                  <p className="text-xs text-slate-600 mt-1">For independent real estate agents and candidate valuers.</p>
                </div>
                ...
                <div className="py-2 border-y border-slate-200">
                  ...
                  <div className="text-[11px] text-slate-400 mt-0.5">Approx $40 USD / mo</div>
                </div>
              ...
              <button
                ...
                className="mt-6 w-full py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl text-xs transition-colors"
              >
            ...
            <div className="bg-gradient-to-b from-cyan-50 to-white border-2 border-cyan-400 rounded-2xl p-6 flex flex-col justify-between relative shadow-lg shadow-cyan-100">
              ...
              <div className="space-y-4 pt-2">
                <div>
                  <h3 className="text-lg font-bold text-slate-900 flex items-center justify-between">
                    ...
                    <span className="text-xs text-cyan-600 font-normal">Full OS Suite</span>
                  </h3>
                  <p className="text-xs text-slate-600 mt-1">Complete spatial intelligence, deeds lookups, and multi-portal sync.</p>
                </div>

                <div className="py-2 border-y border-cyan-500/30">
                  <div className="flex items-baseline gap-1">
                    <span className="text-3xl font-extrabold text-cyan-600 font-mono">
                      {billingCycle === 'annual' ? 'R 1,480' : 'R 1,850'}
                    </span>
                    <span className="text-xs text-slate-500">/ month (ex VAT)</span>
                  </div>
                  <div className="text-[11px] text-cyan-600/70 mt-0.5">Approx $99 USD / mo</div>
                </div>

                <ul className="space-y-2.5 text-xs text-slate-700">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-cyan-600 shrink-0 font-bold" />
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between hover:border-slate-300 shadow-sm transition-all">
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-bold text-slate-900">Enterprise Brokerage</h3>
                  <p className="text-xs text-slate-600 mt-1">For national real estate brands, franchises, and conveyancing firms.</p>
                </div>
                ...
                <div className="py-2 border-y border-slate-200">
                  ...
                  <div className="text-[11px] text-slate-400 mt-0.5">Approx $265 USD / mo</div>
                </div>
      ...
      <section id="about" className="py-20 border-b border-slate-200/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-3 text-xs text-slate-300">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[10px] text-slate-400 uppercase font-semibold">Support & Inquiries</div>
                    <div className="font-bold text-slate-900">support@ptahrealty.com</div>
                  </div>
                </div>

                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 shadow-sm flex items-center justify-center text-emerald-600">
                    <PhoneCall className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="text-[10px] text-slate-400 uppercase font-semibold">Practitioner Priority Line</div>
                    <div className="font-bold text-slate-900">+27 (0) 21 890 4120 / +27 66 349 6137</div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-200 space-y-2 text-xs">
                <div className="font-bold text-slate-700">Global Operational Hubs:</div>
                <div className="grid grid-cols-2 gap-2 text-[11px] text-slate-500">
                  <div>ðŸ‡¿ðŸ‡¦ Cape Town (HQ)</div>
                  <div>ðŸ‡¬ðŸ‡§ London City (Coming soon)</div>
                  <div>ðŸ‡ºðŸ‡¸ New York (Coming soon)</div>
                  <div>ðŸ‡¸ðŸ‡¬ Singapore Hub (Coming soon)</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
              <h3 className="text-xl font-bold text-slate-900 mb-2">Request an Agency Walkthrough</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs mb-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-lg text-slate-900 focus:ring-2 focus:ring-cyan-500 focus:outline-none"
                  />
                </div>
                <div>
                  <label className="block text-slate-700 font-semibold mb-1">Corporate / Agency Email</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-slate-700 font-semibold mb-1">Agency / Brokerage Name</label>
                  <input
                    type="text"
              ...
              <div className="mb-4 text-xs">
                <label className="block text-slate-700 font-semibold mb-1">How can we help your agency?</label>
                <textarea
                  rows={2}
                  placeholder="Tell us about your team size, required deeds registry feeds, or multi-portal syndication requirements..."
                  className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-lg text-slate-900 focus:ring-2 focus:ring-cyan-500 focus:outline-none resize-none"
                />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-slate-200 pb-6 mb-6">
            ...
            <div className="flex items-center gap-2 text-[11px]">
              ...
              <span className="text-emerald-400 font-mono font-semibold">ALL 196 NATIONAL DEEDS GATEWAYS OPERATIONAL</span>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
            <div>
              Â© {new Date().getFullYear()} Ptah Real Estate & Cadastral Intelligence Technologies. All Rights Reserved.
            </div>
            <div className="flex items-center gap-4">
              <a href="#about" className="hover:text-cyan-400">Data Governance</a>
              <a href="#contact" className="hover:text-cyan-400">POPIA & GDPR Disclosures</a>
              <a href="#pricing" className="hover:text-cyan-400">Statutory Licensing</a>
              <button onClick={() => setIsLoginOpen(true)} className="text-cyan-400 hover:underline">Practitioner Login</button>
            </div>
          </div>
        </div>
      </footer>
