...
const inputCls =
  "w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded px-3 py-2 text-xs text-slate-800 dark:text-slate-200 focus:outline-hidden focus:border-amber-500";

function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <label className="block">
      <span className="block text-[10px] font-mono text-slate-600 dark:text-slate-500 mb-1">{label}</span>
      {children}
    </label>
  );
}
  ...
  return (
    <div className="space-y-8">
      <div className="border-b border-slate-200 dark:border-slate-900 pb-4">
        <h2 className="font-sans font-bold text-2xl text-slate-900 dark:text-white flex items-center gap-2 uppercase">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded p-5 space-y-3">
        <span className="text-[10px] font-mono text-slate-600 dark:text-slate-500 uppercase tracking-wider block">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 disabled:bg-white dark:disabled:bg-slate-900 disabled:text-slate-500 dark:disabled:text-slate-600 text-slate-800 dark:text-slate-200 font-sans font-bold px-4 rounded text-xs flex items-center gap-1.5 border border-slate-300 dark:border-slate-700 transition-all"
          >
        ...
        {ingestCount !== null && (
          <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-mono">Upserted {ingestCount} comparable sales.</p>
        )}
        {ingestError && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Step 1: Property */}
        <div className="lg:col-span-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded p-5 space-y-4">
          <span className="text-[10px] font-mono text-slate-600 dark:text-slate-500 uppercase tracking-wider block">
            1. Property Details
          </span>
          ...
          <button
            ...
            className="w-full bg-amber-500 hover:bg-amber-400 disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-600 dark:disabled:text-slate-500 text-slate-950 font-sans font-bold py-3 rounded text-xs flex items-center justify-center gap-1.5 transition-all"
          >
            {isSavingProperty ? (
          ...
          {propertyId && (
            <span className="text-[10px] font-mono text-slate-600 dark:text-slate-500 block truncate">ID: {propertyId}</span>
          )}

          {propertyId && (
            <div className="border-t border-slate-200 dark:border-slate-800 pt-4 space-y-3">
              <span className="text-[10px] font-mono text-slate-600 dark:text-slate-500 uppercase tracking-wider block flex items-center gap-1.5">
              ...
              <label className="w-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-sans font-bold py-3 rounded text-xs flex items-center justify-center gap-1.5 transition-all border border-slate-300 dark:border-slate-700 cursor-pointer">
              ...
              {mediaList.length > 0 && (
                <ul className="space-y-1.5">
                  {mediaList.map((m) => (
                    <li
                      key={m.id}
                      className="flex items-center justify-between gap-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded px-2.5 py-1.5"
                    >
                      ...
                      <button
                        ...
                        className="text-slate-600 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 shrink-0"
        ...
        <div className="lg:col-span-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded p-5 space-y-4">
          ...
          <button
            ...
            className="w-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 disabled:bg-white dark:disabled:bg-slate-900 disabled:text-slate-500 dark:disabled:text-slate-600 text-slate-800 dark:text-slate-200 font-sans font-bold py-3 rounded text-xs flex items-center justify-center gap-1.5 transition-all border border-slate-300 dark:border-slate-700"
          >
          ...
          {valuation && (
            <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded p-4 space-y-2">
              <span className="text-[10px] font-mono text-slate-600 dark:text-slate-500 block uppercase">Estimated Value</span>
              <div className="font-sans text-2xl font-extrabold text-emerald-600 dark:text-emerald-400">
              ...
              <div className="flex justify-between text-[10px] font-mono text-slate-600 dark:text-slate-500 pt-2 border-t border-slate-200 dark:border-slate-900">
        ...
        <div className="lg:col-span-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded p-5 space-y-4">
          ...
          {publishResult && (
            <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded p-3 space-y-2">
              {publishResult.success ? (
                ...
                <>
                  ...
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed">{publishResult.error_message}</p>
                  {publishResult.feed_xml && (
                    <button
                      onClick={copyFeedXml}
                      className="w-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 text-[10px] font-mono py-1.5 rounded flex items-center justify-center gap-1.5 border border-slate-300 dark:border-slate-700"
                    >
      ...
      <div className="flex items-center gap-2 text-[10px] font-mono text-slate-500 dark:text-slate-600 border-t border-slate-200 dark:border-slate-900 pt-4">
